...
setwd("C:/Users/Administrator/Dropbox/Documents/Work and School/Teaching/CPLN 671 - Statistics and Data Mining/Data/Lecture 2 - R")
...
writeOGR(PhillyData, ".", "Exported_PhillyDataset1", driver="ESRI Shapefile")
